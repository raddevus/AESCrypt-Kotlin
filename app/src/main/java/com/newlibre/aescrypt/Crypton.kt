...
class Crypton(val password: String, val targetBytes: ByteArray) {
    ...
    fun processData(ivIn: String, isEncrypt: Boolean = true): String{
        ...
        val rawSha256OfPassword = hexStringToByteArray(password)//.slice(0..15).toByteArray() //ConvertStringToSha256(password);
        ...
        val iv : ByteArray = hexStringToByteArray(ivIn)//iv.slice(0..15).toByteArray()
